...
public class BillDao {
    ...
    {
        String query = "insert into bill values ('"+bill.getId()+"','"+bill.getName()+"','"+bill.getMoblieNumber()+"','"+bill.getEmail()+"','"+bill.getDate()+"','"+bill.getTotal()+"','"+bill.getCreatedBy()+"')";
    ...
    public static ArrayList<Bill> getAllRecordsByInc(String date) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                bill.setMoblieNumber((rs.getString("moblieNumber")));
