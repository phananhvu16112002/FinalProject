...
public class VerifyUser extends javax.swing.JFrame {
    ...
    public void getAllRecord(String email)
    {
        ...
        while(itr.hasNext())
        {
            ...
            {
                dtm.addRow(new Object[] {userObj.getId(),userObj.getName(),userObj.getEmail(),userObj.getMoblieNumber(),userObj.getAddress(),userObj.getSecurityQuestion(),userObj.getStatus()});
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 90, 350, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Email", "Moblie Number", "Address", "Security Question", "Status"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 1370, 514));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("*Click on row to change data");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 640, -1, -1));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/background cate (1).jpg"))); // NOI18N
