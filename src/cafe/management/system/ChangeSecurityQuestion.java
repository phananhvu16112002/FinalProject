...
public class ChangeSecurityQuestion extends javax.swing.JFrame {
    ...
    public void validateField()
    {
        ...
        String securityQuestion = txtNewSecurity.getText();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Change Secuirty Question");
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(603, 16, -1, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Old Security Question:");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(111, 105, -1, -1));
        getContentPane().add(txtOldSecurity, new org.netbeans.lib.awtextra.AbsoluteConstraints(301, 103, 246, -1));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("New Security Question:");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(111, 139, -1, -1));
        ...
        getContentPane().add(txtNewSecurity, new org.netbeans.lib.awtextra.AbsoluteConstraints(301, 137, 246, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("New Answer:");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(111, 173, -1, -1));
        ...
        getContentPane().add(txtNewAnswer, new org.netbeans.lib.awtextra.AbsoluteConstraints(301, 171, 246, -1));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Password:");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(111, 207, -1, -1));
        ...
        getContentPane().add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(301, 254, -1, -1));
        ...
        getContentPane().add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(432, 254, -1, -1));
        ...
        getContentPane().add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(301, 205, 246, -1));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/background cate.jpg"))); // NOI18N
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        String securityQuestion = txtNewSecurity.getText();
        String answer = txtNewAnswer.getText();
        UserDao.chaneSecurityQuestion(userEmail, password, securityQuestion, answer);
        setVisible(false);
